...
import { editShapeItemShape,  deleteShapeItem, editShapeItemName, addShapeItem, endProccess, startProccess } from '@careebiz/pages/Main/ducks/actions';
...
export default class ShapeForm extends Component<ShapeFormProps & WithStyles<typeof styles>, ShapeFormState> {
    ...
    handleSelectShapeType = (e) => {
        const activeShapeItem = { ...this.state.activeShapeItem, type: e.target.value }
