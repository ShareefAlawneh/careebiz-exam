...
function reducer(state: ShapeItemState, action: ShapItemStateDispatcher): ShapeItemState {
    switch(action.key){
        case "showUndo":
...
export const useShapeItemState  = (): [ShapeItemState, React.Dispatch<ShapItemStateDispatcher>] => {
